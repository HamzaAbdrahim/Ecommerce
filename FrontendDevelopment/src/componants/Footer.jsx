...
<footer class="bg-white dark:bg-gray-900">
    <div class=" w-full">
    <div class="px-14 py-10 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span class="text-xl text-gray-500 dark:text-gray-300 sm:text-center">© 2023 <a href="#" >Only Brownies™</a>. All Rights Reserved.
        </span>
