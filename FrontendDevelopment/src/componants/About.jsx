        ...
        <div className="text-center">
            ...
            <div className={`${styles.paddingY} ${layout.section} items-center gap-20`} >
                ...
                <div className={`${layout.sectionInfo} flex flex-col gap-4`}>
                    <h3 className="text-5xl font-semibold mb-4 max-w-3xl leading-normal text-left">Tempor erat elitr rebum clita. Diam dolor diam </h3>
                    <p className="text-2xl text-scondary leading-10 ">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
                </div>
                <div>
